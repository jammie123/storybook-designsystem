...
<Meta title="Design System/Guideline/Forms" /> 
...
- Vysvětlení požadavků na pro vstup předem. Pokud vstup vyžaduje specifikcý formát nebo pravidla např. politika hesla, PSČ, telefoní číslo atd. Sdělte je uživatelovi předem.
...
## Label a placeholder, pravidla

### Vyvarujte se používat label jako placeholder, proč:
...
### Jak používat label, placeholder a helper text
